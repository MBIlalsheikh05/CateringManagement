...
function Signup() {
  ...
  const handleSignup = (e) => {
    e.preventDefault();
    // You can add any local functionality here if needed

    // Automatically navigate to login or another page after signup
    navigate('/login'); // Redirects to login after signup (you can change this route)
  };
